...
class TFTSevenSegmentClockDisplay : public TFTSevenSegmentDisplay {
  ...
  public:
    TFTSevenSegmentClockDisplay(  Adafruit_ST7735* ,  int16_t  ,  int16_t,  int16_t,  int16_t,  uint16_t,  uint16_t,  int16_t );
    /*!
    ...
    */
    TFTSevenSegmentClockDisplay(Adafruit_ST7735 * , int16_t , int16_t , int16_t , int16_t , uint16_t , uint16_t , int16_t , boolean, float );
