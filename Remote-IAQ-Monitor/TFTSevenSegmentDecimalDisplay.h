...
class TFTSevenSegmentDecimalDisplay : public TFTSevenSegmentDisplay {
  ...
  public:
    ...
    */
    TFTSevenSegmentDecimalDisplay(Adafruit_ST7735 * , int16_t , int16_t , int16_t , int16_t , uint16_t , uint16_t , int16_t  );
    ...
    */
    ...
    /*!
       @brief    Display time from hour, minutes ans seconds
        @param   thousands number to display on the hours subgroup module
    ...
    */
    void display(int16_t , int16_t , int16_t , int16_t );
  ...
  private:
    static const int16_t DIGITS = 4; // number of seven segment modules for the clock display
    TFTSevenSegmentModule* digits[DIGITS];
    enum Unit {THOUSANDS, HUNDREDS , TENS, ONES};
