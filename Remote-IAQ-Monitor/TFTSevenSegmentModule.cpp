...
/*!
  @brief Create a TFTSevenSegmentModule represent a seven segment module than can display one digit
   @param tft       pointer to Adafruit_ST7735
...
*/
TFTSevenSegmentModule::TFTSevenSegmentModule(Adafruit_ST7735* tft, int16_t x = 0, int16_t y = 0, int16_t w = 16, int16_t h = 32, uint16_t onColor = 0, uint16_t offColor = 0, int16_t ledWidth = 3, boolean on = true)
...
/*!
  @brief    Change Adafruit_ST7735 instance to display on
  @param tft                pointer to Adafruit_ST7735
*/
void TFTSevenSegmentModule::setTft(Adafruit_ST7735* tft) {
  m_tft = tft;
}
